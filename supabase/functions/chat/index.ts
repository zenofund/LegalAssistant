        ...
        <div className={`prose prose-sm max-w-none ${
          ...
          {message.role === 'user' ? (
            ...
            <ReactMarkdown 
              ...
              components={{
                // Enhanced heading styles with better spacing and hierarchy
                h1: ({children}) => (
                ...
                h4: ({children}) => (
                  <h4 className="text-base font-medium mb-2 mt-3 text-gray-700 first:mt-0">
                    {children}
                  </h4>
                ),
                
                // Enhanced paragraph styles with better spacing
                p: ({children}) => (
